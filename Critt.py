...
class MyWidget(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        if not sa:
            sa = 'C:\\Users\\дом\\PycharmProjects\\pythonProject1\\landscape-forest-trees-nature-2004265.jpg'
        b = 501
        c = 334
        img = Image.open(sa)
        img = img.resize((b, c), Image.ANTIALIAS)
        img.save('C:/Users/дом/PycharmProjects/pythonProject1/somepic.png')
        r = QPixmap("C:/Users/дом/PycharmProjects/pythonProject1/somepic.png")
    ...
    def change(self):
        ...
        if yt >= dt.datetime(int(k[0]), int(k[1]), int(k[2]), int(t[0]), int(t[0]), int(t[1]), round(float(t[2]))):
            ...
            action.Path = "C:\\Users\\дом\\AppData\\Local\\Programs\\Python\\Python39\\python.exe"
            action.Arguments = 'Critt.py'
            action.WorkingDirectory = 'C:\\Users\\дом\\PycharmProjects\\pythonProject1'
...
class Options(QMainWindow, Ui_MainWindow_Options):
    def __init__(self):
        ...
        with open('avatar.txt', 'r') as file:
            path = file.read()
        if path == "":
            path = 'C:\\Users\\дом\\PycharmProjects\\pythonProject1\\profile.png'
        img = Image.open(path)
        img = img.resize((120, 120), Image.ANTIALIAS)
        img.save('C:/Users/дом/PycharmProjects/pythonProject1/smallprof.png')
        r = QPixmap("C:/Users/дом/PycharmProjects/pythonProject1/smallprof.png")
        self.showava.setPixmap(r)
        with open('C:\\Users\\дом\\PycharmProjects\\pythonProject1\\user_name.txt', 'r') as file:
            f = file.read()
        if f == "":
            f = 'User'
...
class Choose(QMainWindow, Ui_MainWindow_Redact_List):
    ...
    def plus(self):
        ...
        t = f'C:\\Pictures\\{e}'
        copy(path, t)
        r = open("C:/Users/дом/PycharmProjects/pythonProject1/list_of_pict.txt", 'r').read()
        u = open("C:/Users/дом/PycharmProjects/pythonProject1/list_of_pict.txt", 'w')
        u.write(f'{r}\n{t}\n')
    ...
    def delete(self):
        ...
        if path:
            ...
            with open('C:/Users/дом/PycharmProjects/pythonProject1/list_of_pict.txt', 'w') as file:
                file.write(filedata)
            os.remove(path)
...
class Login(QMainWindow, Ui_MainWindow_Login):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        img = Image.open('C:\\Users\\дом\\PycharmProjects\\pythonProject1\\profile.png')
        img = img.resize((180, 180), Image.ANTIALIAS)
        img.save('C:/Users/дом/PycharmProjects/pythonProject1/login.png')
        r = QPixmap("C:/Users/дом/PycharmProjects/pythonProject1/login.png")
        self.dialogs = []
        self.label.setPixmap(r)
    ...
    def new(self):
        ...
        count = cursor.execute(sqlite_insert_query, ("User", self.lineEdit_3.text(),
                                                     self.lineEdit_4.text(), "C:\\Users\\дом\\PycharmProjects\\pythonProject1\\profile.png"))
        sqlite_connection.commit()
        cursor.close()
        main = MyWidget()
        p = open('C:/Users/дом/PycharmProjects/pythonProject1/user_name.txt', "w+")
        p.write("User")
        wq = open("C:/Users/дом/PycharmProjects/pythonProject1/avatar.txt", "w+")
        wq.write('C:\\Users\\дом\\PycharmProjects\\pythonProject1\\profile.png')
        self.dialogs.append(main)
        main.show()
        self.close()
    ...
    def old(self):
        ...
        if result:
            for elem in result:
                ...
                p.write(elem[0])
                p.close()
                i = open('C:\\Users\\дом\\PycharmProjects\\pythonProject1\\avatar.txt', "w+")
                i.write(elem[-1])
                i.close()
                main = MyWidget()
                self.dialogs.append(main)
...
notes = []
pict = open("C:/Users/дом/PycharmProjects/pythonProject1/list_of_pict.txt", "r").read().split("\n")
minutes = open("C:/Users/дом/PycharmProjects/pythonProject1/minutes.txt", 'r').read()
if minutes:
    minutes = int(minutes)
else:
    minutes = 60
user = open('C:\\Users\\дом\\PycharmProjects\\pythonProject1\\user_name.txt', 'r').read()
if not user:
    user = "User"
main = ''
opt = ''
